...
//     int? id,
//     int? maximumOrder,
//     @JsonKey(fromJson: categoryListFromMap, toJson: categoryListToMap) List<CategoryList>? categoryList,
//     String? productName,
//     String? sku,
//     String? slug,
//     String? buisnessName,
...
// List<CategoryList>? categoryListFromMap(List<Map<String, dynamic>>? json) {
//   if (json != null) {
//     final List<CategoryList> list = json.map((e) => CategoryList.fromJson(e)).toList();
